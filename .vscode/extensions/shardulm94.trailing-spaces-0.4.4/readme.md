...
- [@leighmcculloch](https://github.com/leighmcculloch): Added support for the `ui` and `workspace` extension kinds [PR [#50](https://github.com/shardulm94/vscode-trailingspaces/issues/50)](https://github.com/shardulm94/vscode-trailingspaces/pull/50)
- [@dnicolson](https://github.com/dnicolson): Fixed the `util.isNullOrUndefined` deprecation warning [PR [#78](https://github.com/shardulm94/vscode-trailingspaces/issues/78)](https://github.com/shardulm94/vscode-trailingspaces/pull/78)
